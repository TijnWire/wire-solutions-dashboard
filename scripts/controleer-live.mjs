...
for (const [wat, naald] of [
  ...
  ["saneren: kaartje in de bus per adres", "Kaartje in de bus"],
  ["saneren: hele portiek op dezelfde dag", "Hele portiek thuis op"],
  ...
  ["verdelen: groepen aanvinken en toewijzen", "Vink groepen aan om ze in één keer"],
  ...
  ["saneren: één werklijst", "Rijd langs deze deuren"],
  ...
  ["saneren: afboeken op het PD-nummer", "Afboeken op het PD-nummer"],
