...
function IntegratiesTab({ isLeiding }: { isLeiding: boolean }) {
  ...
  // Lokaal vs. centraal — laat zien of data daadwerkelijk in de cloud staat.
  const vergelijk = [
        ...
        {test && (
          <div className="mt-3 overflow-hidden rounded-lg border border-ink-200">
            ...
            <div className="border-t border-ink-100 px-3 py-1.5 text-[11px] text-ink-500">
              Staat er centraal 0 terwijl dit apparaat data heeft? Dan komt de data niet in de cloud (database nog niet juist ingericht). Anders verschijnt alles vanzelf op alle apparaten.
            </div>
          </div>
        )}
      </Card>
