...
export const SEED_USERS: User[] = [
  { id: "u-adi", naam: "Adelcao Mendes Moreira", initialen: "AM", email: "adi@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "EYmqVgMgjnqgZ1Fa2D2r7HDGhzdKbqUZSBEp4iJy8ww=", wachtwoordSalt: "cwH2h4lPAMypaKilWB0s8w==", wachtwoordIter: 150000 },
  { id: "u-brandon", naam: "Brandon Santos Cabral", initialen: "BC", email: "brandon@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "13ihhvAqLMuq1UEoARGnbGT98S4bKGyUmPz5C/EA5hw=", wachtwoordSalt: "/sPoiFG0onxYRj4pf7ii/A==", wachtwoordIter: 150000 },
  { id: "u-denilcao", naam: "Denilcao Mendes Moreira", initialen: "DM", email: "denilcao@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "/N68QkJp+ebKif9kd1SC48JBzQqP/q7a1Nk+V8Ymfrc=", wachtwoordSalt: "OT/xLQBjjwIKTB2bS/tisw==", wachtwoordIter: 150000 },
  { id: "u-edilson", naam: "Edilson dos Santos", initialen: "ES", email: "edilson@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "8fIFt2S138vAfBJ5HrnMTllqBaiXW3A9tqPG2AxcyaE=", wachtwoordSalt: "KQEhPXcEjtcjT9GYk9eETA==", wachtwoordIter: 150000 },
  { id: "u-guus", naam: "Guus Zaal", initialen: "GZ", email: "guus@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "PuIdhCTK4q79jeQjKrh33wZ6aGRP+bcsXplwLUERbrE=", wachtwoordSalt: "HBkIw0dvU+If8iyvpLxWIA==", wachtwoordIter: 150000 },
  { id: "u-jackie", naam: "Jackie Klijnoot", initialen: "JK", email: "jackie@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "MEz01+E/G0yO3Dn5mKxc8PfB49XuswUO1WR8WCk4Vv8=", wachtwoordSalt: "m7wsoFJdOJqSQpznYyLd4w==", wachtwoordIter: 150000 },
  { id: "u-melany", naam: "Melany Bout", initialen: "MB", email: "melany@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "8wmje45lSZ3FDsXIkuEnCtdH7ACd98WqgN36NIXohkQ=", wachtwoordSalt: "IPfgG139+2csQXTLHrlDDg==", wachtwoordIter: 150000 },
  { id: "u-mitchell", naam: "Mitchell Korving", initialen: "MK", email: "mitchell@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "We2vBZ7YUNV3Pf6Uu9VX4QIz6ca3zkt435Xg5S/CvPQ=", wachtwoordSalt: "s2ItQm/8xxoibvQIs/lkdg==", wachtwoordIter: 150000 },
  { id: "u-nathalie", naam: "Nathalie Kerdel", initialen: "NK", email: "nathalie@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "XxCGvVc32Ot62XznffSEjehuxoY9rEVRDyomdN/8bwo=", wachtwoordSalt: "bmVgX1pxKhEzvGrag0Zdfw==", wachtwoordIter: 150000 },
  { id: "u-patrick", naam: "Patrick Rüter", initialen: "PR", email: "patrick@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "pJINpEEHquJ/87m0atIiCopZp5MxBXHQHMJIzggVk0M=", wachtwoordSalt: "ji0TBTXpZgRSHQ7jLcBpbw==", wachtwoordIter: 150000 },
  { id: "u-stefano", naam: "Stefano Wareman", initialen: "SW", email: "stefano@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "hlsM0SD/3FWiLo65lpR55EX6gruMngNvyIgq1pJchx8=", wachtwoordSalt: "5m77fdFsntEQTaMV71EubQ==", wachtwoordIter: 150000 },
  { id: "u-tijn", naam: "Tijn den Haan", initialen: "TH", email: "tijn@wiresolutions.nl", rol: "eigenaar", functie: "Eigenaar", wachtwoordHash: "IzLnw4dRDcAccnucBVQ5M73JRs1fipwgbJM4dBUndqQ=", wachtwoordSalt: "MXbqXg/8QNTMNaNVY+sPFw==", wachtwoordIter: 150000 },
  { id: "u-wesley", naam: "Wesley Bout", initialen: "WB", email: "wesley@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "wi5EQeKDQR0e+zfmbky7mAtZrfvP5q442Jkdpiw3Dhw=", wachtwoordSalt: "DzigilbRJKitATC9Oz2d2Q==", wachtwoordIter: 150000 },
  { id: "u-roxanne", naam: "Roxanne van Heijst", initialen: "RH", email: "roxanne@wiresolutions.nl", rol: "monteur", functie: "Werknemer", wachtwoordHash: "DLfWzlWZz/crzfz3FMZ+WgKUrYRqoIU613lNXnoAs+s=", wachtwoordSalt: "EDstMie8Aiaa4eRLfbGMdA==", wachtwoordIter: 150000 },
  { id: "u-remon", naam: "Remon Klijnoot", initialen: "RK", email: "remon@wiresolutions.nl", rol: "beheer", functie: "Leiding", wachtwoordHash: "ZyGOvtu13xEBi5sElIXM1M9i431z5qG+CQDhDMOgKxo=", wachtwoordSalt: "+n9AbjXRBQF87zwVLbcy/w==", wachtwoordIter: 150000 },
  { id: "u-willem", naam: "Willem Klijnoot", initialen: "WK", email: "willem@wiresolutions.nl", rol: "beheer", functie: "Leiding", wachtwoordHash: "i+mL/llZpWw7vTZCZJlYWd4l7PAXs5FWhLxKHQcBIZU=", wachtwoordSalt: "fbMn3foUJuF51chyjzy5Bg==", wachtwoordIter: 150000 },
];
